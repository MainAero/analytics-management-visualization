...
//
    ...
    drawHelper.ExtentPrimitive = (function() {
        function _(options) {
    ...
    drawHelper.PolygonPrimitive = (function() {
    ...
    drawHelper.CirclePrimitive = (function() {
    ...
    drawHelper.EllipsePrimitive = (function() {
        function _(options) {
    ...
    drawHelper.PolylinePrimitive = (function() {
    ...
    drawHelper.prototype.createBillboardGroup = function(points, options, callbacks) {
        var markers = new drawHelper.BillboardGroup(this, options);
        markers.addBillboards(points, callbacks);
        return markers;
    }

    drawHelper.BillboardGroup = function(drawHelper, options) {
    ...
    drawHelper.BillboardGroup.prototype.createBillboard = function(position, callbacks) {
    ...
    drawHelper.BillboardGroup.prototype.insertBillboard = function(index, position, callbacks) {
        this._orderedBillboards.splice(index, 0, this.createBillboard(position, callbacks));
    }

    drawHelper.BillboardGroup.prototype.addBillboard = function(position, callbacks) {
        this._orderedBillboards.push(this.createBillboard(position, callbacks));
    }

    drawHelper.BillboardGroup.prototype.addBillboards = function(positions, callbacks) {
        var index =  0;
    ...
    drawHelper.BillboardGroup.prototype.updateBillboardsPositions = function(positions) {
        var index =  0;
        for(; index < positions.length; index++) {
    ...
    drawHelper.BillboardGroup.prototype.countBillboards = function() {
        return this._orderedBillboards.length;
    }

    drawHelper.BillboardGroup.prototype.getBillboard = function(index) {
        return this._orderedBillboards[index];
    }

    drawHelper.BillboardGroup.prototype.removeBillboard = function(index) {
        this._billboards.remove(this.getBillboard(index));
        this._orderedBillboards.splice(index, 1);
    }

    drawHelper.BillboardGroup.prototype.remove = function() {
        this._billboards = this._billboards && this._billboards.removeAll() && this._billboards.destroy();
    }

    drawHelper.BillboardGroup.prototype.setOnTop = function() {
    ...
    drawHelper.prototype.startDrawingPolyshape = function(isPolygon, options) {
        ...
        var positions = [];
        var markers = new drawHelper.BillboardGroup(this, defaultBillboard);
    ...
    drawHelper.prototype.startDrawingExtent = function(options) {
        ...
        function updateExtent(value) {
            ...
            if(markers == null) {
                markers = new drawHelper.BillboardGroup(_self, defaultBillboard);
    ...
    drawHelper.prototype.enhancePrimitives = function() {
        ...
        function setEditMode(editMode) {
                ...
                if(editMode) {
                    ...
                    if(this._markers == null) {
                        var markers = new drawHelper.BillboardGroup(drawHelper, dragBillboard);
                        var editMarkers = new drawHelper.BillboardGroup(drawHelper, dragHalfBillboard);
        ...
        drawHelper.EllipsePrimitive.prototype.setEditable = function() {
    ...
    drawHelper.DrawHelperWidget = (function() {
    ...
    drawHelper.prototype.addToolbar = function(container, options) {
        ...
        return new drawHelper.DrawHelperWidget(this, options);
    }
