...
exports.getData = function (dateResolution, startD, endD, view_id, callback) {
    if (dateResolution === constants.NO_DATE)
        ...
        dimUtils.getDataWithDateCallback(dateResolution, startD, endD, view_id, constants.PASS_BY, constants.COUNT_MET, dimUtils.valueCountEvaluator, callback);
};
