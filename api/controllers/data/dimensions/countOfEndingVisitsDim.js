...
exports.getName = function () {
    return constants.ENDING_VISITS;
};
...
exports.getData = function (dateResolution, startD, endD, view_id, callback) {
    if (dateResolution === constants.NO_DATE)
        ...
        dimUtils.getDataWithDateCallback(dateResolution, startD, endD, view_id, constants.ENDING_VISITS, constants.COUNT_MET, dimUtils.valueCountEvaluator, callback);
};
...
exports.getDataNoDate = function (dateResolution, startD, endD, view_id, callback) {
    ...
    var conditionEntered = { $match: {$and: [
        ...
        {"dimension": constants.ENDING_VISITS},
